...
// cpmem 486 thru 488, 489 is 488 + 1
  ...
  flash_setup(); // flash_ops.cpp
   ...
   delay(2000);
   SERIAL_LOCAL_C.println  ("");
   SERIAL_LOCAL_C.println  (" myForth Arm Cortex   de wa1tnr  ItsyBitsyM4 09 SEP 2019 14:28z");
   SERIAL_LOCAL_C.println  ("      Mon Sep  9 14:28:23 UTC 2019 0.2.0-alpha.1 non-usart");
   SERIAL_LOCAL_C.println  ("      +0.2.0-a.1  +sam +autoload +squote +fdir_planned ++rlist +cc");
   SERIAL_LOCAL_C.println  ("      +0.2.0-a.1  +blist +mkdir +write_File +fload        shred: abn-731");

   SERIAL_LOCAL_C.println  ("      words: sam fload wlist warm - do NOT use fload without disabling autoload");
   SERIAL_LOCAL_C.println  ("      TEF MEK Hn-r");
}
